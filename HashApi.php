...
function sendHashApi(string $string, bool $override = false): array
{
    ...
    if ($override || ($_SERVER['HTTP_USER_AGENT'] === 'FaviEdge/25.5.19')) {
        ...
        $sha256 = 'sha256-' . sha256Base64($string);
        $sha384 = 'sha384-' . sha384Base64($string);
        $sha512 = 'sha512-' . sha512Base64($string);
        $sha1 = 'sha1-' . base64_encode(sha1($string, true));
        header("FX-HashApi-CHash: $sha256, $sha384, $sha512, $sha1");
